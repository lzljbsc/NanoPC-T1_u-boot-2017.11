...
#define		USER_DATA_PART_SIZE		(512*1024*1024)
#define		CACHE_PART_SIZE			(512*1024*1024)
...
/////////////////////////////////////////////////////////////////
int get_mmc_mbr(char *const device_name, unsigned char *mbr)
{
    int rv;
    struct mmc *mmc;
    int dev_num;
...
int put_mmc_mbr(unsigned char *mbr, char *device_name)
{
    ...
    rv = blk_dwrite(desc, 0, 1, mbr);

    /* // TODO: È·ÈÏÊÇ·ñÐèÒªÉèÖÃ ext_csd */
...
/////////////////////////////////////////////////////////////////
int get_mmc_part_info(char *const device_name, int part_num, int *block_start, int *block_count, unsigned char *part_Id)
{
    int		rv;
